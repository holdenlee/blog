...
A book is not merely the abstract set of words that is contains. The book as physical artifact influences the story that it tells.
...
This will make learning much more personal and guided in a way we don't really comprehend. The closest thing that we have now is browsing Wikipedia. Imagine if all learning were a richer form of Wikipedia where you could lose yourself in association. Authors could become known for the originality and beauty of their association webs. <!--(You would build on top of that.)-->
<!--That's the true vision of the memex, and -->
