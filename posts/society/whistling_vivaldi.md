...
<!-- Stereotype threat is so persistent and powerful that it can't be overcome. -->
...
# 2 A Mysterious link between identity and performance
...
<!--how do people maintain a perception of personal adequacy in the face of information that could threaten that perception?-->
...
* Asian students studied in groups, which brought many heads together and allowed them to focus more on the concepts rather than the arithmetic. Studying together counted as social life.
...
<!-- (ex. makes us vigilant to everything relevant to the threat, raises doubt, leads to constant monitoring, etc.)-->
...
<!--cf. two types of evaluation---summative vs. formative
freedom to make mistakes
growth mindset
https://750words.com/day/2013-05-19
diminishing of variance is a strategic update.
