...
First task is to install 

# Code highlighting

Get [highlight.js](https://highlightjs.org/download/) for all languages you will use, and put it in the folder highlight/ in the blog directory. Now add
